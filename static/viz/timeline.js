/**
*  Simple timeline for publication time
*  http://bl.ocks.org/rengel-de/5603464 is the basis for this template. 
*/
...
timeline = function() {
  ...
  function showGraph(timeseries) {
    //timeseries.forEach(
      let domElement = "#timeline";
      //function (data) {
         timeline(domElement)
            .data(timeseries)
            .band("mainBand", 0.82)
